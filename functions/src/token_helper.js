...
async function tokenGenerateHelper(channelName, uid, userRole) {
...
exports.generateToken = functions.https.onRequest(async (req, res) => {
  return cors(req, res, async () => {
    try {
      ...
      const { token, privilegeTs } = await tokenGenerateHelper(channelName, uid, userRole);
...
module.exports = {tokenGenerateHelper};