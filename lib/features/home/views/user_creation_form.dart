                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text('Creating User Under Member Code', style: TextStyle(color: Colors.blue[700], fontWeight: FontWeight.w600)),
                          ],
                        ),
                    ...
                    child: ElevatedButton(
                      ...
                      child:
                          _isLoading
                              ...
                              : const Text('Create User', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
                    ),
                  ),
