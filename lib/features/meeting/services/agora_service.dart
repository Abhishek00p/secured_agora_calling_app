...
final remoteUsersProvider = StateNotifierProvider<RemoteUsersNotifier, List<int>>(
    ...
    _engine!.registerEventHandler(
      RtcEngineEventHandler(
        ...
        onRemoteAudioStateChanged: (RtcConnection connection, int remoteUid, 
          ...
          debugPrint("Remote user $remoteUid audio state changed to ${state.toString()}");
          final bool audioEnabled = state == RemoteAudioState.remoteAudioStateDecoding;
          onUserAudioStateChanged?.call(remoteUid, audioEnabled);
        },
        onRemoteVideoStateChanged: (RtcConnection connection, int remoteUid, 
          RemoteVideoState state, RemoteVideoStateReason reason, int elapsed) {
          debugPrint("Remote user $remoteUid video state changed to ${state.toString()}");
          final bool videoEnabled = state == RemoteVideoState.remoteVideoStateDecoding;
